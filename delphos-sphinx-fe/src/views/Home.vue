  ...
  <div class="Home">
    ...
    <div class="Home-card Home-createRoom">
      ...
      <div class="Home-container">
        ...
        <input type="password" v-model="roomPassword" id="roomPassword" placeholder="simple_password">
    ...
    <div class="Home-card Home-createRoom">
      ...
      <div class="Home-container">
        ...
        <input type="password" v-model="joinRoomPassword" id="joinRoomPassword" placeholder="simple_password">
      </div>
      <button @click="joinToRoom"> Create Room </button>
    </div>
